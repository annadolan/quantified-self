...
function fillMealTable(totalCalsID, remainingCalsID, arrayPosition){
...
function initialTableFiller(){
  fillExerciseTable();
  fillMealTable('breakfast-total-cals', 'breakfast-remaining-cals', 1);
  fillMealTable('lunch-total-cals', 'lunch-remaining-cals', 2);
  fillMealTable('dinner-total-cals', 'dinner-remaining-cals', 3);
  fillMealTable('snacks-total-cals', 'snacks-remaining-cals', 4);
  // fillBreakfastTable();
  // fillLunchTable();
  // fillDinnerTable();
  // fillSnacksTable();
