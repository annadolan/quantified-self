// under each date in localStorage is stored a json string which contains
...
function setExDiaryLocalStorage(){
  var diaryJSON = localStorage.getItem('diary-exercise');
  ...
  // get the table data and itterate over it adding it to local storage
  ...
  var jsonString = "{" + pageDate + ": {'exercise': {'totalCalories': '124', 'tableData': {'name': 'sampledate', 'calories': 'sampleData'}}}}";
  currentDiary.push(jsonString);
